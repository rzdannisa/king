                ...
                <div class="col-md-12">
                    <div class="choose">
                        ...
                        <a href="/note">Create a new note...</a><br><br>
                            ...
                            <div class="input">
                                        <form method="POST" action="{{ url('/updatenote') }}">
                                            <input  style="background-color: #49C69E !important;" class="inp" type="text" name="title_notes" placeholder=" Title Note" value="{{ $data->title_notes }}" requiered/><br><br>
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="hidden" name="id" value="{{ $data->id }}">
                                            <label>Note Description</label>
                                            <textarea style=" background-color: #49C69E !important; color:#fff;" class="form-control ckeditor" name="content" rows="6" required> {!! $data->content !!}</textarea><br>
