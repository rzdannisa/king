...
<body>
    ...
    <div class="navbar navbar-inverse set-radius-zero">
        <div class="container">
            ...
            <div class="left-div">
                <a href= "/login"><i class="fa fa-user login-icon" ></i></a>
        </div>
            </div>
        </div>
    <!-- LOGO HEADER END-->
                ...
                <div class="col-md-6">
                	...
                	@endforeach
                   	<form method="POST">
                        ...
                        <select style="width:100%;height:36px;" name="gender">
                        ...
                        <input style="height:36px;" type="file" name="photo" class="" style="" />
                        <hr />
                        <button type="submit" class="btn btn-info"><span class="glyphicon glyphicon-user"></span> &nbsp;Register </a>&nbsp;
                	</form>
                </div>
                <div class="col-md-6">
