              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                  ...
                  <div id="external-events">
                    ...
                    <div class="external-event bg-green">{{ $events->title_event }}</div>
                    @endforeach
                    <div class="checkbox">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                  ...
                  <div class="input-group" >
                    <form id="formadd" method="POST" action="{{ url('/addevent') }}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input id="new-event" type="text" name="title_event" class="form-control" placeholder="Event Title">
                    <div class="input-group-btn">
                      <button type="submit" id="add-new-event" class="btnev"> Add </button>
                    </form>
                    </div><!-- /btn-group -->
                  </div><!-- /input-group -->
                </div>
