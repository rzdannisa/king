                ...
                <div class="col-md-12">
                    <div class="choose">
                        ...
                        <a style="color: #fff !important;" href="/task">Create a new task...</a><br><br>
                            <div class="btn-group" >
                                <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" style="background-color: #fff !important;color: #6CB9BF !important; border:none;" aria-expanded="false">Tasks List <span class="caret"></span></button>
                        ...
                        <a style="color: #fff !important;;"href="/taskbook">Create a new taskbook...</a><br><br>
                            <div class="btn-group">
                                <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" style="background-color: #fff !important;color: #6CB9BF !important; border:none;" aria-expanded="false">Task Books List <span class="caret"></span></button>
                            ...
                            <div class="input">
                                        <form method="POST" action="{{ url('/savetaskbook') }}">
                                            <input style=" background-color: #6CB9BF !important;" class="inp" type="text" name="title_task_book" placeholder=" Title Task Book"/><br>
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <select style=" background-color: #6CB9BF !important;border:none;width:100%;" class="form-inp" name="priority">
                                                  <option value="">- Choose Priority -</option>
                                                  <option value="High">High</option>
                                                  <option value="Medium">Medium</option>
                                                  <option value="Standart">Standar</option>
                                            </select><br>
                                            <input style=" background-color: #6CB9BF !important;"  class="datepicker" type="text" name="start"/> Date Range
                                            <input style=" background-color: #6CB9BF !important;"  class="datepicker" type="text" name="finish"/><br>
                                            <label>Task Description</label>
                                            <textarea style=" background-color: #6CB9BF !important;"  class="form-control ckeditor" name="content" rows="6"></textarea><br>
