                        ...
                        <a style="color: #fff !important;;"href="/taskbook">Create a new taskbook...</a><br><br>
                            ...
                            <div class="input">
                                        <form method="POST" action="{{ url('/savetask') }}">
                                            <input style=" background-color: #DD7B92 !important;" class="inp" type="text" name="title_task" placeholder=" Title Task"  /><br>
                                            ...
                                            <select style=" background-color: #DD7B92 !important;border:none;" class="form-inp" name="id_task_book">
                                                  <option value="">- Choose Task Book -</option>
                                                  @foreach($taskbook as $taskbook)
                                                    <option value="{{ $taskbook->id }}">{{ $taskbook->title_task_book }}</option>
                                                  @endforeach
                                            </select><br>
                                            <input style=" background-color: #DD7B92 !important;"  class="datepicker" type="text" name="start"  /> Date Range
                                            <input style=" background-color: #DD7B92 !important;"  class="datepicker" type="text" name="finish"  /><br>
                                            <label>Task Description</label>
                                            <textarea style=" background-color: #DD7B92 !important;"  class="form-control ckeditor" name="content" rows="6"  ></textarea><br>
