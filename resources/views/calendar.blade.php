...
<head>
    ...
    <link href="/css/bootstrap_calendar/bootstrap_calendar.css" rel="stylesheet" />
    <!-- FONT AWESOME ICONS  -->
...
<body>
                    ...
                    <ul class="nav">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-settings">
                                ...
                                <hr />
                                <a href="#" class="btn btn-info btn-sm">Full Profile</a>&nbsp; <a href="/logout" class="btn btn-danger btn-sm">Logout</a>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Calendar</h4>
