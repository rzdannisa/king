...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">TASK </h4>
                ...
                <div class="col-md-12">
                    <div class="choose">
                        ...
                        <a style="color: #fff !important;;"href="/taskbook">Create a new taskbook...</a><br><br>
                            ...
                            <div class="input">
                                        <form method="POST" action="{{ url('/savetask') }}">
                                        <div class="act"><a href="{{ url('/edittask/'.$data->id) }}">
                                        <i class="fa fa-pencil-square-o"></i></a></td>
                                        <a href="{{ url('/deletetask/'.$data->id) }}" onclick="return confirm('Sure delete it?')">
                                        <i class="fa fa-trash"></i></a></div>
                                            <b><input style=" background-color: #DD7B92 !important;text-align:center;font-size:14pt;" class="inp" type="text" name="title_task" value="{{ $data->title_task }}" readonly  /></b><br>
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <label style="font-size:12pt;"><b>Priority &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></label>
                                            <input style=" background-color: #DD7B92 !important;width:32%;font-size:12pt;text-align:center;" class="inp" type="text" name="title_task" value="{{ $data->priority }}" readonly  />
                                            <label style="font-size:12pt;margin-left:20px;"><b>Task Book &nbsp;&nbsp;&nbsp;:</b></label>
                                            @foreach($task_book as $task_book)
                                            <input style=" background-color: #DD7B92 !important;width:34.5%;font-size:12pt;text-align:center;" class="inp" type="text" name="title_task" value="{{ $task_book->title_task_book }}" readonly  /><br>
                                            @endforeach
                                            <br>
                                            <label style="font-size:12pt;"><b>Progress &nbsp;&nbsp;&nbsp;:</b></label>
                                            <input style=" background-color: #DD7B92 !important;width:86%;font-size:12pt;text-align:center;" class="inp" type="text" name="title_task" value="{{ $data->progress }}" readonly  />
                                            <br>
                                            <input style=" background-color: #DD7B92 !important;width:42%;font-size:12pt;text-align:center;" class="inp" type="text" name="title_task" value="{{ $data->start }}" readonly  />
                                            <label style="font-size:12pt;"><b>Date Range</b></label>
                                            <input style=" background-color: #DD7B92 !important;width:42.5%;font-size:12pt;text-align:center;" class="inp" type="text" name="title_task" value="{{ $data->finish }}" readonly  />
                                            <br><br>
                                            <label style="font-size:12pt;"><b>Task Description</b></label>
                                            <textarea style=" background-color: #DD7B92 !important; color:#fff;"  class="form-control ckeditor" name="content" rows="6" readonly  >{!! $data->content !!}</textarea><br>
